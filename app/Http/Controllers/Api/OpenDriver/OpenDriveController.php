...
class OpenDriveController extends ResponseController
{
    ...
    public function __construct()
    {
        ...
        $this->sessionid = OpenDriver::where("UserName",env('OD_USERNAME'))->first()["SessionID"];
    }
    ...
    private function process($method, $apipath, $options){
        ...
        //die(var_dump($options));
           ...
           return $res->then(function (ResponseInterface $res){
    ...
    */
    ...
    public function  UploadFile(Request $request, $folderid = "NzBfMTE5NjQ5NF9BR2MxdQ" )
    {
